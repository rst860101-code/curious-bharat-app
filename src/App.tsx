          ...
          <div className="fixed inset-0 bg-black/85 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="p-6 overflow-y-auto space-y-5 text-zinc-300">
                ...
                <div className="p-4 rounded-2xl bg-gradient-to-r from-red-950/30 to-zinc-900/40 border border-red-900/30 flex items-center justify-between relative overflow-hidden group">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/5 rounded-full blur-2xl" />
                  <div className="flex items-center gap-4 z-10">
                    {/* Floating 3D Red Price Tag */}
                    <div className="w-16 h-16 bg-red-500/10 rounded-xl border border-red-500/20 flex items-center justify-center overflow-hidden shrink-0">
                      <ThreeDElement type="priceTag" className="w-16 h-16" autoRotate={true} interactive={true} />
                    </div>
                    <div>
                      <span className="text-[9px] font-mono font-bold tracking-widest text-red-400 uppercase flex items-center gap-1.5 bg-red-950/60 px-2 py-0.5 rounded-full border border-red-900/40 w-fit">
                  ...
                  <div className="text-right z-10 shrink-0 bg-black/40 border border-zinc-900/80 px-3.5 py-2 rounded-xl">
                    ...
                    <p className="text-base font-black font-mono text-red-400 tracking-tight">{globalCheckoutCourse.price}</p>
                  </div>
                </div>
